...
# i love history :) but just in IT
# bindkey "^[[5~" up-line-or-search # searches for just one word
# bindkey "^[[6~" down-line-or-search # the same thing
bindkey "^[[5~" history-beginning-search-backward
bindkey "^[[6~" history-beginning-search-forward

# jump word for word in shell
...
alias nano='sl' # for trolling myself using nano (nano is bad)
...
poundify() {
	...
	# wuhu.. the command above closes your fuckin shell.. so you always fail xD
}
